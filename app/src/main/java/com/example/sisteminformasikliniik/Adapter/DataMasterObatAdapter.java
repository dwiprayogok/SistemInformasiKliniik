...
public class DataMasterObatAdapter extends RecyclerView.Adapter<DataMasterObatAdapter.DataMasterObatViewHolder> implements Filterable {
    ...
    public DataMasterObatAdapter(List<DataObatEntity> dataObatEntityList, onActionObatClicked onActionObatClicked) {
    ...
    @NonNull
    @Override
    public DataMasterObatViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = null;
        ...
        return new DataMasterObatViewHolder(view,dataObatEntityList.size());
    }

    @Override
    public void onBindViewHolder(@NonNull DataMasterObatViewHolder holder, int position) {
    ...
    class DataMasterObatViewHolder extends RecyclerView.ViewHolder {
        private TextView labelTv;
        private TextView tvValue;
        private ImageView optional;
        private View itemView;

        public DataMasterObatViewHolder(View itemView, int size) {
            super(itemView);
       ...
       /* public void bind(DataObatEntity dataObatEntity) {
            tvValue.setVisibility(View.GONE);
            optional.setVisibility(View.GONE);
            labelTv.setText(dataObatEntity.getNamaObat());
            itemView.setOnClickListener(v -> {
                onActionObatClicked.onItemClicked(dataObatEntity,v);
            });
        }*/
    }
}
